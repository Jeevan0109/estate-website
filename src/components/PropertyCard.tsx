...
export function PropertyCard({name,baths,beds,id,image,price,rating,sqft}:PropertyCardProps){
    return (
                            ...
                            <div className="flex gap-2 items-center">
                                {
                                    Array(5).fill(0).map((_,index)=>
                                    {
                                        return <div key={index}>
                                            <StarIcon size={16} fill={index < rating ? "orange": "transparent"} color="orange" />
                                        </div>
                                    })
                                }
                                <p className="text-muted-foreground">{rating} / 5</p>
                            </div>
                        </div>
                    </div>    
                </div>
